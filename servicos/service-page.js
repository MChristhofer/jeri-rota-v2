(function () {
  ...
  root.innerHTML = `
    ...
    <main>
      ...
      ${data.itinerary ? `<section class="itinerary section"><div class="wrap"><div class="itinerary-heading"><div><span class="eyebrow">${data.itineraryEyebrow || "Roteiro lado oeste"}</span><h2>${data.itineraryTitle || "Uma jornada entre <em>manguezais, dunas e lagoas</em>"}</h2></div><p>${data.itineraryIntro || "Uma sequência pensada para viver o litoral oeste de Jericoacoara com calma, paisagem e aventura."}</p></div><ol>${data.itinerary.map(function (item, i) { return `<li><span>${String(i + 1).padStart(2, "0")}</span><div><h3>${item[0]}</h3><p>${item[1]}</p></div></li>`; }).join("")}</ol></div></section>` : ""}
      ...
      <section class="important section"><div class="wrap"><span class="eyebrow">Antes de solicitar</span><h2>Informações importantes</h2><ul>${list(data.important)}</ul></div></section>
      <section class="final-cta"><div class="wrap"><span class="eyebrow">Atendimento direto</span><h2>Vamos organizar ${data.title.toLowerCase()}?</h2><p>Envie sua data e a quantidade de pessoas. A equipe responde com disponibilidade, valores, inclusões e as condições para confirmação.</p>${wa("Solicitar informações no WhatsApp")}</div></section>
    </main>
    <footer class="site-footer"><div class="wrap"><div class="footer-grid"><div><a class="brand brand-light" href="/" aria-label="Jeri Rota — página inicial"><span class="brand-mark"><img src="/jeri-rota-logo.png" alt="" width="52" height="52"></span><span class="brand-copy"><b>JERI ROTA</b><small>Experiências no Ceará</small></span></a><p>Transfers, passeios, hospedagens, pacotes e roteiros personalizados por Jericoacoara e outros destinos do Ceará.</p></div><nav aria-label="Navegue"><h3>Navegue</h3><a href="/#servicos">Serviços</a><a href="/#catalogo">Passeios e catálogo</a><a href="/#como-funciona">Como funciona</a><a href="/#duvidas">Dúvidas</a></nav><div class="footer-column"><h3>Passeios principais</h3><a href="/passeio-lado-leste/">Lado Leste</a><a href="/passeio-lado-oeste/">Lado Oeste</a><a href="/extremo-leste/">Extremo Leste</a><a href="/rota-das-emocoes/">Rota das Emoções</a></div><div class="footer-column"><h3>Fale com a gente</h3><a href="https://wa.me/5588982274666" target="_blank" rel="noopener noreferrer">WhatsApp (88) 98227-4666</a><a href="https://wa.me/5585997157910" target="_blank" rel="noopener noreferrer">WhatsApp (85) 99715-7910</a><a href="https://www.instagram.com/jerirota" target="_blank" rel="noopener noreferrer">Instagram @jerirota</a><a href="mailto:contato@jerirota.com.br">contato@jerirota.com.br</a></div></div><div class="legal"><span>© ${new Date().getFullYear()} Jeri Rota. Todos os direitos reservados.</span><span>Imagens ilustrativas e acervo Jeri Rota. Consulte disponibilidade.</span><span>CNPJ 63.754.344/0001-06 · Fortaleza, Ceará</span></div></div></footer>
